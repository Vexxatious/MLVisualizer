...
class KNN:
    def __init__(self, dataset, parameters):
        ...
        self.colors = {i: (random.random(),random.random(),random.random()) for i in self.dataset}
    ...
    def update(self, i):
        ...
        [[plt.scatter(ii[0], ii[1], s=100, c=i) for ii in self.dataset[i]] for i in self.dataset]
